    ...
    , m_translator(new QTranslator(this))
{
    ...
    // 添加关于菜单项
    QAction *actionAbout = new QAction(tr("关于"), this);
    ui->menuSettings->addAction(actionAbout);
...
void MainWindow::createAboutDialog()
{
    ...
    aboutDialog.setWindowTitle(tr("关于 Words"));
    
    QVBoxLayout layout(&aboutDialog);
    
    // 软件名称
    QLabel *titleLabel = new QLabel("Words", &aboutDialog);
    ...
    // 作者信息
    QLabel *authorLabel = new QLabel(tr("作者: TheUserWW"), &aboutDialog);
    authorLabel->setAlignment(Qt::AlignCenter);
    
    // 作者主页链接
    QLabel *websiteLabel = new QLabel("<a href=\"https://github.com/TheUserWW\">https://github.com/TheUserWW</a>", &aboutDialog);
    websiteLabel->setOpenExternalLinks(true);
    websiteLabel->setAlignment(Qt::AlignCenter);
    
    // 许可证信息
    QTextEdit *licenseText = new QTextEdit(&aboutDialog);
    licenseText->setText(Translations::FULL_LICENSE_TEXT());
    licenseText->setReadOnly(true);
    
    // 确定按钮
    QPushButton *closeButton = new QPushButton(tr("确定"), &aboutDialog);
    ...
    layout.addWidget(new QLabel(tr("许可证:")));
